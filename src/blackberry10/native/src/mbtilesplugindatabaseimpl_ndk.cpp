...
namespace webworks {
	...
	MBTilesPluginDataBaseImplNDK::MBTilesPluginDataBaseImplNDK(MBTilesPluginJS *parent, std::string typePath, std::string url)
	...
	Json::Value MBTilesPluginDataBaseImplNDK::getExecuteStatement(const std::string& callbackId, const std::string query, const QList<Json::Value> params)
	{
		Json::FastWriter writer;
		Json::Value root;
		// test if the database is open
